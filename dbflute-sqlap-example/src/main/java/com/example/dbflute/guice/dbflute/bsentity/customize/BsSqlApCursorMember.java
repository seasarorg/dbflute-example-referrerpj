...
/**
 * The entity of SqlApCursorMember. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsSqlApCursorMember implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.guice.dbflute.bsentity.customize.dbmeta.SqlApCursorMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsSqlApCursorMember)) { return false; }
        BsSqlApCursorMember other = (BsSqlApCursorMember)obj;
     ...
     */
    public SqlApCursorMember clone() {
        try {
            return (SqlApCursorMember)super.clone();
