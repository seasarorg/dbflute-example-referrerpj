 ...
 */
public abstract class BsSqlApCursorMember implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlApCursorMember)) { return false; }
        BsSqlApCursorMember otherEntity = (BsSqlApCursorMember)other;
