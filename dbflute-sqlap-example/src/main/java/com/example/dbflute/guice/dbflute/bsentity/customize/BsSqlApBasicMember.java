 ...
 */
public abstract class BsSqlApBasicMember implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlApBasicMember)) { return false; }
        BsSqlApBasicMember otherEntity = (BsSqlApBasicMember)other;
