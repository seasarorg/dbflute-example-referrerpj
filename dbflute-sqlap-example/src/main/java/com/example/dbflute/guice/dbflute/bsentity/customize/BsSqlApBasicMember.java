...
/**
 * The entity of SqlApBasicMember. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsSqlApBasicMember implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.guice.dbflute.bsentity.customize.dbmeta.SqlApBasicMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsSqlApBasicMember)) { return false; }
        BsSqlApBasicMember other = (BsSqlApBasicMember)obj;
     ...
     */
    public SqlApBasicMember clone() {
        try {
            return (SqlApBasicMember)super.clone();
