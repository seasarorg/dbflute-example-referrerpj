package com.example.dbflute.guice.freeflute.dto.bs.customize;
...
/**
 * The simple DTO of SqlApBasicMember. <br />
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsSqlApBasicMemberDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlApBasicMemberDto)) { return false; }
        final BsSqlApBasicMemberDto otherEntity = (BsSqlApBasicMemberDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlApBasicMember");
