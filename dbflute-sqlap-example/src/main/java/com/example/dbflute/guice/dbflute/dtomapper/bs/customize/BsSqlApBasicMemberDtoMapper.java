 ...
 */
public abstract class BsSqlApBasicMemberDtoMapper implements DtoMapper<SqlApBasicMember, SqlApBasicMemberDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlApBasicMemberDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlApBasicMemberDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlApBasicMemberDto mappingToDto(SqlApBasicMember entity) {
        if (entity == null) {
            return null;
        }
        SqlApBasicMemberDto dto = new SqlApBasicMemberDto();
     ...
     * {@inheritDoc}
     */
    public List<SqlApBasicMemberDto> mappingToDtoList(List<SqlApBasicMember> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlApBasicMemberDto> dtoList = new ArrayList<SqlApBasicMemberDto>();
        for (SqlApBasicMember entity : entityList) {
            SqlApBasicMemberDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlApBasicMember mappingToEntity(SqlApBasicMemberDto dto) {
        if (dto == null) {
            return null;
        }
        SqlApBasicMember entity = new SqlApBasicMember();
     ...
     * {@inheritDoc}
     */
    public List<SqlApBasicMember> mappingToEntityList(List<SqlApBasicMemberDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlApBasicMember> entityList = new ArrayList<SqlApBasicMember>();
        for (SqlApBasicMemberDto dto : dtoList) {
            SqlApBasicMember entity = mappingToEntity(dto);
            if (entity != null) {
