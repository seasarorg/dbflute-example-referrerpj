...
/**
 * The base class for typed parameter-bean of SqlApSubDirectoryCheck. <br />
 * This is related to "<span style="color: #AD4747">subdirectory:selectSqlApSubDirectoryCheck</span>" on MemberBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsSqlApSubDirectoryCheckPmb implements ListHandlingPmb<MemberBhv, SqlApSubDirectoryCheck>, EntityHandlingPmb<MemberBhv, SqlApSubDirectoryCheck>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlApSubDirectoryCheck. <br />
     * This is related to "<span style="color: #AD4747">subdirectory:selectSqlApSubDirectoryCheck</span>" on MemberBhv.
     */
    public BsSqlApSubDirectoryCheckPmb() {
    }
    ...
    public String getOutsideSqlPath() {
        return "subdirectory:selectSqlApSubDirectoryCheck";
    }
     ...
     */
    public Class<SqlApSubDirectoryCheck> getEntityType() {
        return SqlApSubDirectoryCheck.class;
    }
