...
/**
 * The entity of SqlApSubDirectoryCheck. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsSqlApSubDirectoryCheck implements Entity, Serializable, Cloneable, DerivedMappable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.guice.dbflute.bsentity.customize.dbmeta.SqlApSubDirectoryCheckDbm.getInstance();
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof BsSqlApSubDirectoryCheck)) { return false; }
        BsSqlApSubDirectoryCheck other = (BsSqlApSubDirectoryCheck)obj;
     ...
     */
    public SqlApSubDirectoryCheck clone() {
        try {
            return (SqlApSubDirectoryCheck)super.clone();
