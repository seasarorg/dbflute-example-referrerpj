 ...
 */
public abstract class BsSqlApSubDirectoryCheck implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlApSubDirectoryCheck)) { return false; }
        BsSqlApSubDirectoryCheck otherEntity = (BsSqlApSubDirectoryCheck)other;
