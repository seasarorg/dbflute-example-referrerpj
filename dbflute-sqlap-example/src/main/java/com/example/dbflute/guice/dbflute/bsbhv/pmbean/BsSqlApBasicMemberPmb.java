...
/**
 * The base class for typed parameter-bean of SqlApBasicMember. <br />
 * This is related to "<span style="color: #AD4747">selectSqlApBasicMember</span>" on MemberBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsSqlApBasicMemberPmb implements ListHandlingPmb<MemberBhv, SqlApBasicMember>, EntityHandlingPmb<MemberBhv, SqlApBasicMember>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlApBasicMember. <br />
     * This is related to "<span style="color: #AD4747">selectSqlApBasicMember</span>" on MemberBhv.
     */
    public BsSqlApBasicMemberPmb() {
    }
     ...
     */
    public Class<SqlApBasicMember> getEntityType() {
        return SqlApBasicMember.class;
    }
