...
/**
 * The base class for typed parameter-bean of SqlApCursorMember. <br />
 * This is related to "<span style="color: #AD4747">selectSqlApCursorMember</span>" on MemberBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsSqlApCursorMemberPmb implements CursorHandlingPmb<MemberBhv, Void>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlApCursorMember. <br />
     * This is related to "<span style="color: #AD4747">selectSqlApCursorMember</span>" on MemberBhv.
     */
    public BsSqlApCursorMemberPmb() {
    }
    ...
    public String getOutsideSqlPath() {
        return "selectSqlApCursorMember";
    }
