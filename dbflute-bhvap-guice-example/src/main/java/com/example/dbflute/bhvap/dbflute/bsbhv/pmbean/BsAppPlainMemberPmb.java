...
/**
 * The base class for parameter-bean of AppPlainMember.
 * @author DBFlute(AutoGenerator)
 */
public class BsAppPlainMemberPmb implements ParameterBean, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the parameter-bean of AppPlainMember.
     */
    public BsAppPlainMemberPmb() {
    }
