...
/**
 * The entity of BhvApPurchaseMaxPriceMember. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 * String purchaseMaxPrice = entity.getPurchaseMaxPrice();
 ...
 */
public abstract class BsBhvApPurchaseMaxPriceMember implements Entity, Serializable, Cloneable {
    ...
    protected String _purchaseMaxPrice;
    ...
    public String getTableDbName() {
        return "BhvApPurchaseMaxPriceMember";
    }
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.bhvap.dbflute.bsentity.customize.dbmeta.BhvApPurchaseMaxPriceMemberDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBhvApPurchaseMaxPriceMember)) { return false; }
        BsBhvApPurchaseMaxPriceMember otherEntity = (BsBhvApPurchaseMaxPriceMember)other;
     ...
     */
    public BhvApPurchaseMaxPriceMember clone() {
        try {
            return (BhvApPurchaseMaxPriceMember)super.clone();
     ...
     */
    public void setPurchaseMaxPrice(String purchaseMaxPrice) {
