package com.example.dbflute.bhvap.dbflute.bsbhv.pmbean;
...
/**
 * The base class for typed parameter-bean of BhvApPurchaseMaxPriceMember. <br />
 * This is related to "<span style="color: #AD4747">selectBhvApPurchaseMaxPriceMember</span>" on MemberBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsBhvApPurchaseMaxPriceMemberPmb extends SimplePagingBean implements EntityHandlingPmb<MemberBhv, BhvApPurchaseMaxPriceMember>, ManualPagingHandlingPmb<MemberBhv, BhvApPurchaseMaxPriceMember>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of BhvApPurchaseMaxPriceMember. <br />
     * This is related to "<span style="color: #AD4747">selectBhvApPurchaseMaxPriceMember</span>" on MemberBhv.
     */
    public BsBhvApPurchaseMaxPriceMemberPmb() {
    ...
    public String getOutsideSqlPath() {
        return "selectBhvApPurchaseMaxPriceMember";
    }
     ...
     */
    public Class<BhvApPurchaseMaxPriceMember> getEntityType() {
        return BhvApPurchaseMaxPriceMember.class;
    }
