...
/**
 * The base class for typed parameter-bean of BhvApSimpleMember. <br />
 * This is related to "<span style="color: #AD4747">selectBhvApSimpleMember</span>" on MemberBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsBhvApSimpleMemberPmb implements ListHandlingPmb<MemberBhv, BhvApSimpleMember>, EntityHandlingPmb<MemberBhv, BhvApSimpleMember>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of BhvApSimpleMember. <br />
     * This is related to "<span style="color: #AD4747">selectBhvApSimpleMember</span>" on MemberBhv.
     */
    public BsBhvApSimpleMemberPmb() {
    }
    ...
    public String getOutsideSqlPath() {
        return "selectBhvApSimpleMember";
    }
     ...
     */
    public Class<BhvApSimpleMember> getEntityType() {
        return BhvApSimpleMember.class;
    }
